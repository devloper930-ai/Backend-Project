...
import { createpost, DeleteAccount, DeletePost, GetPost, GetProfile } from "../controllers/main.controller.js";
...
mainRouter.post('/delete-account', verifyToken, DeleteAccount)
